...
with tab1:
    ...
    if sold is None or sold.empty:
        ...
        show = show.rename(columns={
            ...
            "profit_before_tax_opex": "Прибыль (до), ₽",
            "profit_before_tax_opex_per_unit": "Прибыль/шт (до), ₽",
            "profit": "Прибыль (после), ₽",
        ...
        cols = [
            ...
            "Прибыль (до), ₽","Прибыль/шт (до), ₽","Прибыль (после), ₽","Прибыль/шт (после), ₽",
            "Маржинальность, %","ROI, %"
        ]
